...
- [ ] @quality-director — NEEDS REVISION → Re-review requested. Addressed: (1) DATA-FILTER-01: `deleted_at IS NULL` added to both queries; (2) TEST-BUDGET-01: concrete test plan with budget math (4 new tests, 1798/1800, consolidation fallback identified)
