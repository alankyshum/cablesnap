...
- [ ] **AC15** Permissions Rationale Activity is reachable from HC's permission UI (manual verification recorded in PR description with screenshot from Z Fold6). [TODO-test: BLD-1218]
