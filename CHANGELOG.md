...
- **Wider heatmap legend luminance ramp for protanopia** — Widens the luminance ramp of the workout-history heatmap legend steps under protanopia, ensuring the steps are clearly distinguishable. ([BLD-3878](/BLD/issues/BLD-3878))
