...
- **F-Droid R8 shrinker no longer fails on excluded proprietary integrations**, keeping the F-Droid release build green while the Play build's shrinker configuration is unchanged. ([BLD-4340](/BLD/issues/BLD-4340))
