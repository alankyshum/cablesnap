...
- **F-Droid builds now use robust balanced-brace replacement for CameraViewModule.kt**, ensuring reliable neutralization of ML Kit/GMS scanners in nested AsyncFunction blocks. ([BLD-4413](/BLD/issues/BLD-4413))
