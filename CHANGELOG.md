...
- **F-Droid barcode stub now uses `mutableListOf<Int>()` for corner points**, fixing a Kotlin argument-type mismatch that broke `compileReleaseKotlin` and blocked the Scheduled Release build.
