...
- **F-Droid builds now correctly strip all four proprietary namespaces** (Google Play Services, Firebase, ML Kit, and Install Referrer) from direct Expo module dependency declarations, restoring the GMS-free guarantee after a regression.
