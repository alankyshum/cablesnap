...
- **F-Droid Wear OS build resolves absolute path for ProGuard rules**, ensuring R8 can find and apply the F-Droid specific keep and dontwarn rules during the minified build. ([BLD-4431](/BLD/issues/BLD-4431))
