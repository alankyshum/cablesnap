...
export const CHANGELOG: ReleaseEntry[] = [
  {
    ...
    "date": "2026-05-03",
    "versionCode": 92,
    "body": "- Internal release — no further user-facing changes since v0.26.20. (Cron release pipeline shipped a versionCode bump before BLD-1025 added the changelog gate; this entry exists so F-Droid clients see something other than the v0.26.19 sidecar.)"
  },
  {
    "version": "0.26.21",
    "date": "2026-05-03",
    "versionCode": 91,
    "body": "- Internal release — no user-facing changes since v0.26.20. (Backfilled retroactively under BLD-1025.)"
  },
  {
    "version": "0.26.20",
    "date": "2026-05-02",
