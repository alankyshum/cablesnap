...
export const CHANGELOG: ReleaseEntry[] = [
  ...
  },
  {
    ...
    "date": "2026-07-24",
    "versionCode": 150,
    "body": "- **Muscle-Group Volume Balance insight** — The home screen now shows a proactive notification when any tracked muscle group is below this week's target (below MEV) or above this week's cap (above MRV) for the current week, with a tap that opens the Muscle Volume analysis tab pre-filtered to the flagged muscle. ([BLD-3619](/BLD/issues/BLD-3619))"
  },
  {
    "version": "0.26.81",
    "date": "2026-07-23",
    "versionCode": 149,
    "body": "- **Added curated barbell strength programs** — Adds pre-built workout templates for popular strength programs including StrongLifts 5×5, GZCLP, and 5/3/1 Boring But Big (BBB), complete with smart defaults, built-in progression schemes, and easy program selection on the home tab. ([BLD-3562](/BLD/issues/BLD-3562))"
  },
  {
    "version": "0.26.80",
    "date": "2026-07-23",
