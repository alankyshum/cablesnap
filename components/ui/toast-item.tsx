...
const styles = StyleSheet.create({
  ...
  island: { borderRadius: 14, backgroundColor: Colors.light.toastBg, paddingHorizontal: 16, paddingVertical: 10, flexDirection: 'row', alignItems: 'center', overflow: 'hidden' },
